=== WP Control Deck ===
Contributors: Vincent Casilla
Tags: wordpress, control, dashboard
...
A lightweight extension that enhances WordPress and helps reduce friction during development.
...
1. Upload the `wp-control-deck` folder to the `/wp-content/plugins/` directory.
2. Activate WP Control Deck through the Plugins screen in WordPress.
